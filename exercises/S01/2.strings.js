...
let allStringsTogether =  integrationTests + " " + passedValue + " " + failedValue;
console.log(allStringsTogether);

console.log( `${integrationTests}!: ${failedValue}!`)
console.log( `${integrationTests}!: ${passedValue}!`)
